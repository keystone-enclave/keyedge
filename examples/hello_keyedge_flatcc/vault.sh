...
PACKAGE_FILES="eapp/eapp_hello_keyedge_flatcc \
               host/host_hello_keyedge_flatcc \
               $EYRIE_DIR/eyrie-rt"
PACKAGE_SCRIPT="./host_hello_keyedge_flatcc eapp_hello_keyedge_flatcc eyrie-rt"
