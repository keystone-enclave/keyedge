...
#define ____ocall_wrapper_print_string_formal_args , flatbuffers_int8_vec_ref_t v0, int32_t v1
...
#define ____ocall_wrapper_print_int_formal_args , int32_t v0, int32_t v1
...
__flatbuffers_build_scalar_field(0, flatbuffers_, __ocall_wrapper_print_int_msg, flatbuffers_int32, int32_t, 4, 4, INT32_C(0), __ocall_wrapper_print_int)
__flatbuffers_build_scalar_field(1, flatbuffers_, __ocall_wrapper_print_int___return_value, flatbuffers_int32, int32_t, 4, 4, INT32_C(0), __ocall_wrapper_print_int)
