...
__flatbuffers_define_scalar_field(0, __ocall_wrapper_print_int, msg, flatbuffers_int32, int32_t, INT32_C(0))
__flatbuffers_define_scalar_field(1, __ocall_wrapper_print_int, __return_value, flatbuffers_int32, int32_t, INT32_C(0))
