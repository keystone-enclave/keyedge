...
__flatbuffers_define_scalar_field(0, __ocall_wrapper_print_return_value, msg, flatbuffers_int64, int64_t, INT64_C(0))
__flatbuffers_define_scalar_field(1, __ocall_wrapper_print_return_value, __return_value, flatbuffers_int64, int64_t, INT64_C(0))
...
__flatbuffers_define_scalar_field(1, __ocall_wrapper_print_string, size, flatbuffers_int64, int64_t, INT64_C(0))
__flatbuffers_define_scalar_field(2, __ocall_wrapper_print_string, __return_value, flatbuffers_int64, int64_t, INT64_C(0))
